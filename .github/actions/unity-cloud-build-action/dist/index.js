...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createNewBuildTargetForBranch = exports.doShareLinkCreation = exports.parseUseActionCommit = void 0;
/* eslint-disable filenames/match-regex */
/* eslint-disable i18n-text/no-en */
const core = __importStar(__nccwpck_require__(2186));
const axios_1 = __nccwpck_require__(6545);
function parseUseActionCommit(input) {
...
exports.parseUseActionCommit = parseUseActionCommit;
async function doShareLinkCreation(api, buildTargetId, buildNumber) {
    ...
    while (createShareLinkTryNumber < createShareLinkMaxTries) {
        try {
            ...
            if (error instanceof axios_1.AxiosError && error && error.response) {
                core.warning(`Error HTTP response, will retry. Error: ${error.response.data.error}. Status: ${error.response.status}`);
            }
...
exports.createNewBuildTargetForBranch = createNewBuildTargetForBranch;
...
async function run() {
    try {
        ...
        let buildTargetId = core.getInput('buildTargetId');
        const apiKey = core.getInput('apiKey');
        const gitRef = core.getInput('gitRef');
        const gitSha = core.getInput('gitSha');
        const repoUrl = core
            .getInput('repoUrl')
